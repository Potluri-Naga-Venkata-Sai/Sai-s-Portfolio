    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto">
        ...
        <div className="glass-card rounded-xl p-2 neon-border">
          <img
            src={`https://leetcard.jacoblin.cool/${"Naga_Venkata_Sai"}?theme=dark`}
            alt="LeetCode Stats"
        ...
        <div className="glass-card rounded-xl p-2 neon-border">
          <img
            src={`https://leetcode-stats-six.vercel.app/api?username=${"Naga_Venkata_Sai"}&theme=dark`}
            alt="LeetCode Problem Stats"
            className="rounded-lg max-w-full"
            loading="lazy"
          />
        </div>
